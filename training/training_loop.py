...
from utils.train_utils import get_first_batch, compute_test_loss_and_accuracy
from training.optimizer import PullDiag_GT, PullDiag_GD
from models.cnn import new_ResNet18
from models.fully_connected import FullyConnectedMNIST
...
def train(
    ...
    if dataset_name == "CIFAR10":
        ...
        trainloader_list, testloader = get_dataloaders(
    ...
    for epoch in progress_bar:
        ...
        average_loss, accuracy = compute_test_loss_and_accuracy(
        ...
        progress_bar.set_postfix(
            ...
            test_loss=f"{test_loss_history[-1]:.4f}",
            test_accuracy=f"{100 * test_accuracy_history[-1]:.4f}%",
        )
