...
from network_utils import generate_stochastic_geometric_matrices
...
n=24
A, B = generate_stochastic_geometric_matrices(n = n, seed=49)
...
for i in range(20):
    ...
    df_output.to_csv(f"/home/lg/ICML2025_project/PUSHPULL_PROJECT/最终的实验/geometric_repeate/brand_new_for_draw_exp_n={n}_lr={lr}.csv")